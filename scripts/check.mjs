...
assert(projectCss.includes('.project-carousel-viewport{') && projectCss.includes('cursor:grab'), 'Project gallery must support mouse dragging');
assert(projectCss.includes('.project-carousel-thumbnail[aria-pressed=true]'), 'Project gallery must show the selected thumbnail');
